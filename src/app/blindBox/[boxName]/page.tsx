  ...
  return (
    <div className="flex flex-col flex-1 px-4 pb-12">
      ...
      <div className={'flex items-center mt-8'}>
        ...
        <div className="ml-3 text-white text-subheadermb font-SourceSanPro">
          {decodeURIComponent(boxName)}
        </div>
      </div>
      <div
        className={`flex-1 flex ${
          boxGifts.length > 0 ? 'items-start' : 'items-center'
        }  justify-center`}
      >
        {boxGifts && !boxGifts.length && (
          <div className="flex flex-col gap-8 w-full mt-12 justify-center items-center">
            ...
            <p className="text-labelmb font-SourceSanPro text-center text-white005">
              No Gifts in this Blind Box
            </p>
