  ...
  return (
    <div className="universe-bg px-4 h-full flex-1 flex flex-col pb-12 rounded-3xl">
      ...
      <div className="w-full h-[82px] rounded-md bg-primary010 flex justify-start items-center mt-8">
        ...
        <div>
          <p className=" font-SourceSanPro text-white text-body1bdmb">
            Can&apos;t find what you’re looking for?
          </p>
          <div className=" font-SourceSanPro text-white003 text-labelmb ">
            Check out our{' '}
            <a
              className="text-linkColor"
              target="_blank"
              href="https://github.com/lee920217/PhilosopherStone"
            >
              Github
            </a>{' '}
            or find us on{' '}
            <a
              className="text-linkColor"
              target="_blank"
              href="https://discord.gg/ruvmbEApzU"
            >
              Discord
            </a>
          </div>
