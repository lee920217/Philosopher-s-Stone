...
const CreateBlindBox: React.FC<CreateBlindBoxProps> = ({
  onClose,
  onCreateGift,
  onCreateBlindBox,
  walletAddress,
  ...
  return (
    <div className="rounded-lg">
      <p className="text-white001 font-SourceSanPro text-labelmb mb-2">
        Name your Blind Box*
      </p>
      <input
      ...
      />
      {error && (
        <div className="mt-1 text-light-error-function text-labelmb font-SourceSanPro">
          {error}
        </div>
      )}
      <Button
        type="solid"
        label="Create Blind Box"
