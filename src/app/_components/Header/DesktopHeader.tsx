              ...
              >
                ...
                <div className="flex justify-center items-center gap-12 mt-8 pb-8">
                  <div className="flex flex-col gap-2 items-center">
                    <button
                      className="w-8 h-8 bg-primary008 rounded-full flex justify-center items-center"
                      onClick={() => {
  ...
  return (
    <div
      className={`flex items-center gap-2 py-1 ${
        isActive
          ? 'text-white001 text-body1bdmb cursor-default'
          : 'text-white005 text-body1mb cursor-pointer hover:underline'
      }`}
      onClick={onClick}
    >
      {text}
