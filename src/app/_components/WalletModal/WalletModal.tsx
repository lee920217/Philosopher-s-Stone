    ...
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <div className="bg-primary010 p-6 rounded-lg z-10 shadow-md border border-white009">
          ...
          <p className="mb-4 text-body1mb font-SourceSanPro text-white003">
          ...
          <div className="flex flex-col space-y-6">
            {WalletConfigData.map((wallet, index) => (
              <button
                key={index}
                className="hover:bg-white009 w-full flex justify-between items-center py-3 px-6 border border-white001 text-white001 rounded"
                onClick={() => {
              ...
              >
                <div className="flex gap-2">
                  ...
                  <span className="flex-grow text-body1mb font-SourceSanPro ml-2">
                    {wallet.name}
                  </span>
                </div>
                {wallet.recommended && (
